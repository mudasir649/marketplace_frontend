...
import uploadFile from '@/utils/uploadCloudinary';
                                ...
                                <div className={style.inputStyle}>
                                    <Autocomplete
                                        ...
                                        onPlaceSelected={(place) => {
                                            ...
                                            handleLocation(formatted_address);
                                            // setData({ ...data, ['address']: formatted_address })
                                            setAddress(formatted_address || "");
                                        }}
                                        className='border-none w-auto lg:w-52 focus:outline-none'
