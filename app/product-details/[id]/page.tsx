...
import { setProductId, setShowShare, setProductUserId } from "@/store/appSlice";
              ...
              >
                ...
                {product?.price * 1 === 0 ? (
                  ...
                  <>
                    ...
                    <h1 className="text-gray-500 text-sm md:text-xl font-semibold">
                  ...
                  <div className="space-y-4 mb-5 md:mb-0">
                    ...
                    <div className="flex flex-row gap-2 text-gray-600">
                      ...
                      <h1 className="text-black">
                        ...
                        {product.category === "Vans" && t("categories.10")}
                      </h1>
                    </div>
                    <div className="flex flex-row gap-2 text-gray-600">
