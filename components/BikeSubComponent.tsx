...
import { BikeFuelType, bikeBodyShape, bikeExteriorColor, bodyShape, conditionList, gearBox, howContactList, priceList } from '@/utils/dataVariables';
...
export default function BikeSubComponent({ type }: any) {
    ...
    const [data, setData] = useState<IData>({
        category: 'Bikes',
        subCategory: type == 'Motorcycle' ? 'Motorcycle' : type == 'Bicycles' ? 'Bicycles' : type == 'E-scooter' ? 'E-scooter' : type == 'E-bikes' ? 'E-bikes' : '',
        userId: id,
        title: null || '',
        price: null || '',
        minPrice: null || '',
